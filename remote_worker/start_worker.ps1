...
try {
    ...
    $env:WARRANTY_REMOTE_ALLOW_EDGE_CHANNEL = "0"
    $env:WARRANTY_REMOTE_BROWSER = "firefox"
    $env:WARRANTY_REMOTE_BROWSER_CHANNEL = ""
    $env:WARRANTY_REMOTE_BROWSER_EXECUTABLE_PATH = ""

    Write-Host "Starting local worker on http://0.0.0.0:$Port using Firefox" -ForegroundColor Green
