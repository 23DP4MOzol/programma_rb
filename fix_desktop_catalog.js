...
// We want to replace the whole DEVICE_CATALOG dict to strictly ensure ONLY the 7 brands exist,
// using the same data we injected in app.js
...
code = code.replace(/DEVICE_CATALOG: dict\[str, dict\[str, list\[str\]\]\] = \{[\s\S]*?\}\n/, catalogReplacement + '\n');
fs.writeFileSync('desktop_app.py', code);
console.log("DEVICE_CATALOG replaced!");
